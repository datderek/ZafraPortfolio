export default function NavBar() {
  return (
    <nav className={'flex justify-between items-center fixed top-0 left-0 w-full h-16 px-8 pt-8 gap-4 text-black bg-gradient-to-b from-[rgba(0,0,0,0.30)]'}>
      <img className='h-12 md:h-16 animate-dropAndFadeIn' src='/zafraportfolio/logo.svg' />
      <button className={'md:hidden shrink-0 h-3/4 animate-dropAndFadeIn'}>
        <img src='/zafraportfolio/menu.svg' className={'h-full'}/>
      </button>
      <div className={"animate-dropAndFadeIn hidden md:flex flex-[0_1_35%] gap-8 justify-between items-center text-3xl font-['Yantramanav', 'sans-serif'] font-bold tracking-tighter"}>

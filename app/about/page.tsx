  ...
  return (
    <div className='bg-neutral-100'>
      ...
      <main className="pt-40 w-full h-screen flex justify-center items-center">
        <div className="h-full flex-1 p-12 pl-28 pr-14 py-14">
          <p>Insert picture here. Insert picture here. Insert picture here. Insert picture here. Insert picture here.</p>
        </div>
        <div className="h-full flex-1 pl-14 pr-28 py-14">
          <h1 className="text-neutral-800 text-5xl font-bold">ABOUT ME</h1>
